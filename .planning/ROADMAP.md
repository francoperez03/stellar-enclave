...
**Plans**: 7 plans across 3 waves (wave 1 parallel primitives -> wave 2 dashboard UI -> wave 3 end-to-end verification)
  - [x] 05-01-PLAN.md - Persistent /settlements log on the facilitator (DASH-01 spend-history source; wave 1)
  - [x] 05-02-PLAN.md - Registry schema bump + deposit-time nullifier precompute via computeNullifier (DASH-01 bug-proof cross-reference; wave 1)
...
| 7 | 2/7 | In Progress|  | Final preflight; push README; upload DoraHacks writeup (DEMO-04); submit | If final recording fails, submit the day-6 rehearsal cut. |
